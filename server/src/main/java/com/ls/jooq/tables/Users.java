...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The reference instance of <code>leetstack.users</code>
     */
    ...
    /**
     * The column <code>leetstack.users.id</code>.
     */
    ...
    /**
     * The column <code>leetstack.users.email</code>.
     */
    public final TableField<UsersRecord, String> EMAIL = createField(DSL.name("email"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>leetstack.users.first_name</code>.
     */
    public final TableField<UsersRecord, String> FIRST_NAME = createField(DSL.name("first_name"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>leetstack.users.last_name</code>.
     */
    public final TableField<UsersRecord, String> LAST_NAME = createField(DSL.name("last_name"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>leetstack.users.created_date</code>.
     */
    public final TableField<UsersRecord, LocalDateTime> CREATED_DATE = createField(DSL.name("created_date"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>leetstack.users.last_updated_date</code>.
     */
    public final TableField<UsersRecord, LocalDateTime> LAST_UPDATED_DATE = createField(DSL.name("last_updated_date"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>leetstack.users.leetstack_username</code>.
     */
    public final TableField<UsersRecord, String> LEETSTACK_USERNAME = createField(DSL.name("leetstack_username"), SQLDataType.VARCHAR(255), this, "");
    ...
    /**
     * Create an aliased <code>leetstack.users</code> table reference
     */
    ...
    /**
     * Create a <code>leetstack.users</code> table reference
     */
    public Users() {
    ...
    public List<UniqueKey<UsersRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_USERS_UNIQUE_USERNAME);
    }
    ...
    public UserDsaPath userDsa() {
        if (_userDsa == null)
            _userDsa = new UserDsaPath(this, null, Keys.FK_USER_DSA_USER_ID.getInverseKey());
