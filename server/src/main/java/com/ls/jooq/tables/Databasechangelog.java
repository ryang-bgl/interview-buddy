...
import com.ls.jooq.tables.records.DatabasechangelogRecord;
...
public class Databasechangelog extends TableImpl<DatabasechangelogRecord> {
     ...
     */
    public final TableField<DatabasechangelogRecord, String> DATEEXECUTED = createField(DSL.name("DATEEXECUTED"), SQLDataType.CLOB.nullable(false), this, "");
