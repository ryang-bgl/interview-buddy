...
public class Databasechangeloglock extends TableImpl<DatabasechangeloglockRecord> {
     ...
     */
    public final TableField<DatabasechangeloglockRecord, String> LOCKGRANTED = createField(DSL.name("LOCKGRANTED"), SQLDataType.CLOB, this, "");
    ...
    public UniqueKey<DatabasechangeloglockRecord> getPrimaryKey() {
        return Keys.DATABASECHANGELOGLOCK__PK_DATABASECHANGELOGLOCK;
    }
