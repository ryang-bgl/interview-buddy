    ...
    <footer className="bg-slate-900 text-gray-400 py-16 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-4 mb-6">
              <img
                ...
                loading="lazy"
              />
              <span className="text-2xl text-white font-semibold">LeetStack</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
              Save LeetCode solutions with our Chrome extension and master them through spaced repetition on mobile. Transform problem-solving into lasting knowledge.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-11 h-11 bg-slate-800 rounded-xl flex items-center justify-center hover:bg-slate-700 hover:text-white transition-all hover:-translate-y-1">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#extension" className="hover:text-white transition-colors hover:translate-x-1 inline-block">Chrome Extension</a></li>
              <li><a href="#mobile" className="hover:text-white transition-colors hover:translate-x-1 inline-block">Mobile App</a></li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500">&copy; 2025 LeetStack. All rights reserved.</p>
