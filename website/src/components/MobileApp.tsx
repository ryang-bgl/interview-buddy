...
export function MobileApp() {
  const features = [
    {
      ...
      description:
        "Built on SuperMemo SM-2 algorithm, our FSR system ensures you review problems at optimal intervals for maximum retention and long-term memory.",
      color: "purple",
    ...
    },
    {
      ...
      description:
        "All your solutions and review sessions are stored locally in AsyncStorage. Review anywhere, anytime, with optional cloud sync for backup and cross-device access.",
      color: "blue",
    ...
    },
    {
      ...
      description:
        'Home dashboard shows your streak, daily goals, quick stats, and "continue review" cards. Stay motivated with progress insights and helpful tips.',
      color: "green",
    ...
    },
    {
      ...
      description:
        "Access Grind 75, Blind 75, NeetCode 100, and Hot 100 lists. Browse your solved problems or create custom lists for focused practice.",
      color: "orange",
    ...
    },
    {
      ...
      description:
        "Email/OTP registration and login powered by Firebase. Includes onboarding, profile setup, resend flows, and offline tolerance for uninterrupted review.",
      color: "yellow",
    ...
    },
    {
      ...
      description:
        "Built with React Native and Expo for smooth performance on both iOS and Android. Native mobile experience optimized for on-the-go learning.",
      color: "pink",
  ...
  return (
    <section
      id="mobile"
      className="py-24 bg-gradient-to-br from-slate-50 via-purple-50 to-slate-50 relative overflow-hidden"
    >
      {/* Decorative blobs */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-center mb-10">
          <div className="flex items-center gap-4 rounded-2xl border border-purple-200 bg-white px-6 py-4 shadow-xl shadow-purple-100">
        ...
        <div className="text-center mb-20">
          ...
          <p className="max-w-2xl mx-auto text-xl text-gray-600">
            Transform your saved solutions into a powerful spaced repetition
            learning system.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            <div key={index} className="group relative">
              ...
              <div className="relative bg-white p-8 rounded-2xl border-2 border-gray-100 hover:border-gray-200 shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-${feature.color}-500/30 group-hover:scale-110 group-hover:rotate-3 transition-all`}
                >
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-purple-200 text-lg">
                Everything you need for effective spaced repetition learning
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="group bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all hover:-translate-y-1"
                >
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${screen.gradient} rounded-xl flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 transition-transform`}
                  >
