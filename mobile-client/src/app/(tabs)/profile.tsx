...
import { useAuth, useSolutions, useSyncStatus, useAppState } from '@/hooks/useStores';
...
export default function ProfileScreen() {
  ...
  const lastReviewDate = solutions
    ...
    .sort((a, b) => new Date(b.lastReviewedAt!).getTime() - new Date(a.lastReviewedAt!).getTime())[0]?.lastReviewedAt;
    ...
    <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            style={[styles.button, (!canSync || syncStatus === 'syncing') && styles.buttonDisabled]}
            onPress={handleSync}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.aboutText}>
            This app uses spaced repetition (FSR) to help you review and retain your LeetCode solutions.
            The algorithm adjusts review intervals based on how well you remember each solution.
          </Text>
        </View>
      </View>
    </ScrollView>
