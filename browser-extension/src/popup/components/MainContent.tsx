      ...
      <div className="w-[540px] max-w-full rounded-3xl bg-white p-8 shadow-dialog">
        ...
        <header className="flex items-start justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={() => window.open(`https://web.leetstack.app/review/problems/${computeQuestionIndex()}`, '_blank')}
              className="rounded-full bg-green-600 hover:bg-green-700 px-4 py-1.5 text-xs font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-70"
            >
              Review Problem
            </button>
            <button
