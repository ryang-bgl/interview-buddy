...
export interface ListJobsResponse {
  /** List of jobs */
  jobs: GeneralNoteJobStatusResponse[];
 ...
 */
export type TaskStatusOnly<T extends BaseTaskMetadata> = Pick<T, 'status' | 'errorMessage'>;

/**
 * Create a task status update
 */
export type TaskStatusUpdate<T extends BaseTaskMetadata = BaseTaskMetadata> =
  | Partial<Pick<T, 'status' | 'progressPercent' | 'currentStep' | 'errorMessage'>>
