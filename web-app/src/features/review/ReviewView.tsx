        ...
        <CardContent>
          {loading ? (
            ...
            <div className="space-y-4">
              <div
                className={`relative min-h-[200px] cursor-pointer transition-all duration-300 ${isAnswerRevealed ? '' : 'hover:scale-[1.02]'}`}
              ...
              >
                {!isAnswerRevealed ? (
                  <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-muted-foreground/30 bg-muted/20 p-8 text-center">
                    <p className="text-lg font-semibold text-foreground mb-4">{card.prompt}</p>
                  ...
                  <div className="space-y-4 animate-in slide-in-from-top-2 duration-300">
                    ...
                    <div className="space-y-2">
                      ...
                      {card.extra ? (
                        <p className="text-sm text-muted-foreground mt-2">{card.extra}</p>
                      ) : null}
                    </div>
                  </div>
                )}
